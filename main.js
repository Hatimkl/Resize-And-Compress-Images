...
downloadBnt = document.querySelector('.download-btn');
...
const loadFile = (e) =>{
    ...
    previewImg.addEventListener("load",()=>{ //once img loaded adding active class in the wrapper
...
const resizeAndDownload = () => {
    ...
    a.click(); // clicking <a> element so th file download
}

downloadBnt.addEventListener("click", resizeAndDownload);
